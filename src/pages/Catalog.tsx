  ...
  return (
    ...
    >
      <button
        ...
        className="relative aspect-[4/3] w-full shrink-0 overflow-hidden bg-zinc-100 text-left outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2"
      >
        <div
          className={cn(
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        <p className="text-[11px] font-black uppercase tracking-[0.12em] text-zinc-900">{category.name}</p>
        <h3 className="mt-1.5 line-clamp-2 text-sm font-bold uppercase leading-snug text-zinc-600">{product.name}</h3>
        ...
        <button
          ...
          className={cn(
            'mt-4 flex min-h-[2.75rem] w-full items-center justify-center gap-2 rounded-lg border-2 text-xs font-black uppercase tracking-wide transition-colors',
            expanded
